...
class ExceptionHandler {
  ...
  private:
    ...
    std::unordered_map<Interrupt, uint32_t> interrupt2IfMask = {{Interrupt::VBLANK, REG_IF::VBLANK_MASK},
    ...
    std::unordered_map<Interrupt, uint32_t> interrupt2IfShift = {{Interrupt::VBLANK, REG_IF::VBLANK_SHIFT},
