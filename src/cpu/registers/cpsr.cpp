...
uint32_t PSR::getValue() { return value; }

void PSR::setValue(uint32_t val) { value = val; }

PSR::Mode PSR::getMode() {
    switch (getModeUInt()) {
    case MODE_FLAG_USR_VAL:
        return Mode::User;
    case MODE_FLAG_FIQ_VAL:
        return Mode::FIQ;
    case MODE_FLAG_IRQ_VAL:
        return Mode::IRQ;
    case MODE_FLAG_SVC_VAL:
        return Mode::Supervisor;
    case MODE_FLAG_ABT_VAL:
        return Mode::Abort;
    case MODE_FLAG_UND_VAL:
        return Mode::Undefined;
    case MODE_FLAG_SYS_VAL:
        return Mode::System;
    default:
...
uint32_t PSR::getModeUInt() { return Utils::getRegBits(value, MODE_FLAG_MASK, MODE_FLAG_SHIFT); }
...
bool PSR::getNFlag() { return Utils::getRegBits(value, N_FLAG_MASK, N_FLAG_SHIFT); }

bool PSR::getZFlag() { return Utils::getRegBits(value, Z_FLAG_MASK, Z_FLAG_SHIFT); }

bool PSR::getCFlag() { return Utils::getRegBits(value, C_FLAG_MASK, C_FLAG_SHIFT); }

bool PSR::getVFlag() { return Utils::getRegBits(value, V_FLAG_MASK, V_FLAG_SHIFT); }

bool PSR::getIFlag() { return Utils::getRegBits(value, I_FLAG_MASK, I_FLAG_SHIFT); }

bool PSR::getFFlag() { return Utils::getRegBits(value, F_FLAG_MASK, F_FLAG_SHIFT); }
