...
HalfwordDataTransfer::HalfwordDataTransfer(uint32_t op, ARM7TDMI& cpu) : ArmOpcode::ArmOpcode(op, cpu) { init(op); }

HalfwordDataTransfer::HalfwordDataTransfer(
    uint16_t p, uint16_t u, uint16_t w, uint16_t l, uint16_t rn, uint16_t rd, uint16_t s, uint16_t h, ARM7TDMI& cpu) :
...
void HalfwordDataTransfer::init(
    uint16_t p, uint16_t u, uint16_t w, uint16_t l, uint16_t rn, uint16_t rd, uint16_t s, uint16_t h) {
    this->p = p;
    this->u = u;
    this->w = w;
    this->l = l;
...
std::string HalfwordDataTransfer::getUFlagMnemonic() { return uFlag2Mnemonic[u]; }

std::string HalfwordDataTransfer::getSFlagMnemonic() { return sFlag2Mnemonic[s]; }

std::string HalfwordDataTransfer::getHFlagMnemonic() { return hFlag2Mnemonic[h]; }

std::string HalfwordDataTransfer::getWFlagMnemonic() { return wFlag2Mnemonic[w]; }

std::string HalfwordDataTransfer::getOpMnemonic() { return op2Mnemonic[l]; }
