...
HalfwordDataTransferOffset::HalfwordDataTransferOffset(uint16_t p,
                                                       uint16_t u,
                                                       uint16_t w,
                                                       uint16_t l,
                                                       uint16_t rn,
...
HalfwordDataTransferOffset::HalfwordDataTransferOffset(ARM7TDMI& cpu) :
...
uint16_t HalfwordDataTransferOffset::getOffsetVal() { return offsetVal; }
...
void HalfwordDataTransferOffset::doExecute() { _doExecute(offsetVal); }
