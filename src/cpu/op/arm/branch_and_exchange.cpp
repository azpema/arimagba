...
BranchAndExchange::BranchAndExchange(uint32_t op, ARM7TDMI& cpu) : ArmOpcode::ArmOpcode(op, cpu) { init(op); }
...
std::string BranchAndExchange::toString() { return "bx" + getCondFieldMnemonic() + " " + OpCode::getRegMnemonic(Rn); }
