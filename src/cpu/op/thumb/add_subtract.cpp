...
AddSubtract::AddSubtract(uint16_t op, ARM7TDMI& cpu) : ThumbOpCode::ThumbOpCode(op, cpu) { init(op); }
...
std::string AddSubtract::getOpMnemonic() { return op2Mnemonic[opField]; }
