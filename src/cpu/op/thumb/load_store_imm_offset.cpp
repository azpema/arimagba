...
LoadStoreImmOffset::LoadStoreImmOffset(uint16_t op, ARM7TDMI& cpu) : ThumbOpCode::ThumbOpCode(op, cpu) { init(op); }
...
std::string LoadStoreImmOffset::getOpMnemonic() { return op2Mnemonic[l]; }

std::string LoadStoreImmOffset::getBMnemonic() { return b2Mnemonic[b]; }
