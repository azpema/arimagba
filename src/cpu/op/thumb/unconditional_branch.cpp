...
UnconditionalBranch::UnconditionalBranch(uint16_t op, ARM7TDMI& cpu) : ThumbOpCode::ThumbOpCode(op, cpu) { init(op); }

UnconditionalBranch::UnconditionalBranch(ARM7TDMI& cpu) : ThumbOpCode::ThumbOpCode(cpu) {}
...
std::string UnconditionalBranch::toString() { return "b #" + Utils::toHexString(offsetVal); }
...
uint32_t UnconditionalBranch::cyclesUsed() const { return 1; }