...
uint16_t ScreenEntry::getTileIndex() const { return tileIndex; }

bool ScreenEntry::getHorizontalFlip() const { return horizontalFlip; }

bool ScreenEntry::getVerticalFlip() const { return horizontalFlip; }

uint8_t ScreenEntry::getPaletteBank() const { return paletteBank; }
